...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2021 at 03:59 AM
...
--
CREATE DATABASE IF NOT EXISTS `djangoreffral` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `djangoreffral`;
...
--
-- Table structure for table `cryptoticker`
--

CREATE TABLE `cryptoticker` (
  `sno` int(11) NOT NULL,
  `symbol` text CHARACTER SET latin1 NOT NULL,
  `date` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cryptoticker`
--

INSERT INTO `cryptoticker` (`sno`, `symbol`, `date`) VALUES
(31, 'BTCUSDT', '2021-09-28 23:26:53'),
(32, 'TRXUSDT', '2021-09-28 23:27:00'),
(34, 'BNBUSDT', '2021-09-29 08:35:15');
...
--
-- Indexes for table `cryptoticker`
--
ALTER TABLE `cryptoticker`
  ADD PRIMARY KEY (`sno`);
...
--
-- AUTO_INCREMENT for table `cryptoticker`
--
ALTER TABLE `cryptoticker`
...
('root', '[{\"db\":\"djangoreffral\",\"table\":\"home_affliatelink\"},{\"db\":\"djangoreffral\",\"table\":\"home_addproductservices\"},{\"db\":\"djangoreffral\",\"table\":\"home_addsubcategory\"},{\"db\":\"djangoreffral\",\"table\":\"home_addcategory\"},{\"db\":\"djangoreffral\",\"table\":\"home_adminforms\"},{\"db\":\"djangoreffral\",\"table\":\"home_userforms\"},{\"db\":\"djangoreffral\",\"table\":\"home_addsectors\"},{\"db\":\"djangoreffral\",\"table\":\"django_migrations\"},{\"db\":\"djangoreffral\",\"table\":\"django_session\"},{\"db\":\"djangoreffral\",\"table\":\"django_admin_log\"}]');
...
('root', 'djangoreffral', 'django_migrations', '{\"sorted_col\":\"`django_migrations`.`id`  DESC\"}', '2021-10-10 15:19:05'),
('root', 'djangoreffral', 'home_addcategory', '{\"sorted_col\":\"`home_addcategory`.`categoryName` ASC\"}', '2021-10-15 04:09:11'),
('root', 'djangoreffral', 'home_addsectors', '{\"sorted_col\":\"`home_addsectors`.`sectorName` ASC\"}', '2021-10-13 10:00:43'),
('root', 'djangoreffral', 'home_adminforms', '{\"sorted_col\":\"`home_adminforms`.`inputName` ASC\"}', '2021-10-12 09:09:15');
...
('root', '2021-10-20 01:58:43', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":279}');
